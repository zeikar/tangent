...
**Pass**: 0 fail, 1 warn, 10 pass, 0 skip · 10.4 s · contact sheet `check/sheet.png`

| Check | Status | Summary |
|---|---|---|
| freshness | pass | render.mp4 and cues.json were both built from this storyboard.json |
...
| centering | pass | B1 0, B2 0, B3 +24, B4 +2, B5 +3, B6 +3, B7 +10, B8 0, B9 +1 (px off x 540, tolerance ±25) |
