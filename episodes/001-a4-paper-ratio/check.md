...
| centering | pass | B1 0/0, B2 -3/0, B3 -3/0, B4 -2/0, B5 +9/-11, B6 +12/-12, B7 +14/-12, B8 +14/-5, B9 +1/+0, B10 0/0, B11 0/0 (px off x 540: all ink / picture without edge labels; tolerance ±25) |
| legibility | pass | smallest glyph "m" 31 px in dim210 "210\,\mathrm{mm}" (floor 30 px, 52 text items) |
...
| reaction | pass | B1 +1, B2 +1, B3 +1, B4 +1, B5 +1, B6 +1, B7 +1, B8 +1, B9 +1, B10 +1, B11 +1 (frames from each beat's first word to the first visible change; — = no cue on that word; limit 3) |
...
| loop | pass | 142 visual-zone pixels differ by more than 16 levels between the last and first frame (limit 500) |
